...
class Agent:
    ...
    def train_Sarsa(self,policy,episodes = 40000,steps=200,eps_start=0.8,eps_end=0.01,eps_decay=0.9995,alpha=0.1,gamma=0.99):
        reward_per_eps = []
        eps = eps_start
    ...
    def train_Qlearnig(self,policy,episodes = 40000,steps=200,tau_start=2,tau_end=0.1,tau_decay=0.9995,alpha=0.1,gamma=0.99):
        reward_per_eps = []
        tau = tau_start
