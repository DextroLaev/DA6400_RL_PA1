...
def train_qlearning_epsilon(rng, env, qlearning, num_episodes_steps=NUM_SIM_STEPS, test_interval=TEST_INTERVAL, debug=False, wandb_log=False):
    rewards = jnp.zeros(num_episodes_steps)
    test_rewards = jnp.zeros(num_episodes_steps // test_interval)
...
def train_sarsa_softmax(rng, env, sarsa, num_episodes_steps=NUM_SIM_STEPS, test_interval=TEST_INTERVAL, debug=False, wandb_log=False):
    rewards = jnp.zeros(num_episodes_steps)
    test_rewards = jnp.zeros(num_episodes_steps // test_interval)
